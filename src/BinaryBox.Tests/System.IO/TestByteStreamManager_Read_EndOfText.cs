...
namespace BinaryBox.Core.System.IO.Test
{
    public class TestByteStreamManager_Read_EndOfText
    {
        ...
        public async Task TestSuccess(byte endOfText, byte[] data, byte[] expected)
        {
            ...
            // Act
            var result = await byteStreamManager.ReadAsync(endOfText);
        ...
        public async Task TestCancel()
        {
            ...
            var result = await byteStreamManager.ReadAsync((byte)2, 0, cancellationTokenSource.Token);
        ...
        public async Task TestNotOpen()
        {
            ...
            // Act
            var result = await byteStreamManager.ReadAsync((byte)10);
        ...
        public async Task TestUnhandledException()
        {
            ...
            // Act
            Func<Task> func = async () => { await byteStreamManager.ReadAsync((byte)10); };
